...
**Total candidates:** 34 across 6 categories
...
### 5. KRAS-G12D inhibitor MRTX1133: 41% ORR in pancreatic ductal adenocarcinoma

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_kras_g12d_phase1` |
| **Stage** | Phase 1 |
| **Published** | 2026-05-05 (119d ago) |
| **Strength** | 71% |
...
### 7. Low-dose colchicine cuts repeat heart attacks by 31% — now in cardiology guidelines

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_colchicine_postmi_acc` |
| **Stage** | Guideline |
| **Published** | 2026-05-08 (116d ago) |
| **Strength** | 88% |
...
### 8. Memory Changes May Predict Heart Events 8 Years Early

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_e6dece34f86e5874` |
| **Stage** | other |
| **Published** | 2026-06-09 (84d ago) |
| **Strength** | 85% |
...
### 9. Pre-op iron reduces blood needs and improves recovery after heart surgery

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_26eed9a442dc0494` |
| **Stage** | Phase 3 |
| **Published** | 2026-08-24 (8d ago) |
| **Strength** | 85% |
...
### 10. IV iron before heart surgery reduces blood transfusions and improves 90-day recovery

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_b07cf4e81bd58d81` |
| **Stage** | Phase 3 |
| **Published** | 2026-08-26 (6d ago) |
| **Strength** | 85% |
...
### 11. IV iron before heart surgery reduces need for blood transfusions by 7%

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_f8bbb8f9c34029d8` |
| **Stage** | Phase 3 |
| **Published** | 2026-08-22 (10d ago) |
| **Strength** | 80% |
...
### 12. One injection a year cut bad cholesterol roughly in half — for the whole year

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_pcsk9_silencing_long` |
| **Stage** | Phase 2 |
| **Published** | 2026-05-04 (120d ago) |
| **Strength** | 78% |
...
### 13. FDA approves first oral drug to lower LDL cholesterol
...
### 14. Ozempic-class drug improves fatty liver disease in nearly two-thirds of patients

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_semaglutide_mash_phase3` |
| **Stage** | Phase 3 |
| **Published** | 2026-05-12 (112d ago) |
| **Strength** | 90% |
...
### 15. First OTC glucose monitor approved for children with diabetes
...
### 16. AI-Powered Eye Scan Improves Diabetes Vision Screening Accuracy
...
### 17. First Drug Approved to Lower Pancreatitis Risk in Severe High Triglycerides
...
### 18. FDA approves gene therapy for children 2+ with sickle cell disease

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_ab673401325c68f1` |
| **Stage** | Approved / Label |
| **Published** | 2026-08-18 (14d ago) |
| **Strength** | 90% |
...
### 19. New Guidelines Standardize Diagnosis and Treatment for Heart-Kidney-Metabolic Condition
...
### 24. FDA tightens monitoring for new Alzheimer's drug in people with a high-risk gene

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_lecanemab_apoe4_safety` |
| **Stage** | Approved / Label |
| **Published** | 2026-05-10 (114d ago) |
| **Strength** | 85% |
...
### 25. Virtual neurology visits as effective as in-person for first-time patient evaluations

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_efba2df41cc84c9f` |
| **Stage** | Phase 3 |
| **Published** | 2026-06-02 (91d ago) |
| **Strength** | 85% |
...
### 26. Post-surgery confusion linked to future memory problems in older adults
...
### 27. Ebola survivors may face long-term neurological issues, study finds
...
### 28. Web tool helps patients stay on antidepressants longer

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_82c82aa9bbec1885` |
| **Stage** | Phase 3 |
| **Published** | 2026-08-04 (28d ago) |
| **Strength** | 80% |
...
### 29. Pregnant women using acetaminophen not linked to autism or ADHD in children
...
### 30. Low-dose rapamycin once a week improved immune response in healthy older adults

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_rapamycin_aging_phase2` |
| **Stage** | Phase 2 |
| **Published** | 2026-05-06 (118d ago) |
| **Strength** | 62% |
...
### 34. FDA approves first generic single-dose flu treatment, increasing affordability
