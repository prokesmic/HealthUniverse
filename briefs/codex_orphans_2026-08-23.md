...
**Total candidates:** 29 across 6 categories
...
### 13. FDA approves gene therapy for children 2+ with sickle cell disease

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_ab673401325c68f1` |
| **Stage** | Approved / Label |
| **Published** | 2026-08-18 (5d ago) |
| **Strength** | 90% |
...
### 14. New Guidelines Standardize Diagnosis and Treatment for Heart-Kidney-Metabolic Condition
...
### 15. FDA approves new drug for agitation in Alzheimer's dementia patients

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_4f487e92268d5f9a` |
| **Stage** | Approved / Label |
| **Published** | 2026-06-16 (68d ago) |
| **Strength** | 90% |
...
### 16. FDA approves second over-the-counter naloxone nasal spray for opioid overdose

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_47a96cc94db33c7c` |
| **Stage** | Approved / Label |
| **Published** | 2026-07-28 (26d ago) |
| **Strength** | 90% |
...
### 17. Blood thinner more effective than standard drug for migraines linked to heart hole

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_cd80dcb8bd64e525` |
| **Stage** | Phase 3 |
| **Published** | 2026-08-06 (17d ago) |
| **Strength** | 90% |
...
### 18. FDA tightens monitoring for new Alzheimer's drug in people with a high-risk gene

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_lecanemab_apoe4_safety` |
| **Stage** | Approved / Label |
| **Published** | 2026-05-10 (105d ago) |
| **Strength** | 85% |
...
### 19. Virtual neurology visits as effective as in-person for first-time patient evaluations

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_efba2df41cc84c9f` |
| **Stage** | Phase 3 |
| **Published** | 2026-06-02 (82d ago) |
| **Strength** | 85% |
...
### 20. Single psilocybin session helps depression that didn't respond to standard drugs

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_psilocybin_trd_phase3` |
| **Stage** | Phase 3 |
| **Published** | 2026-05-02 (113d ago) |
| **Strength** | 83% |
...
### 21. Post-surgery confusion linked to future memory problems in older adults
...
### 22. Ebola survivors may face long-term neurological issues, study finds
...
### 23. Web tool helps patients stay on antidepressants longer

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_82c82aa9bbec1885` |
| **Stage** | Phase 3 |
| **Published** | 2026-08-04 (19d ago) |
| **Strength** | 80% |
...
### 24. Pregnant women using acetaminophen not linked to autism or ADHD in children
...
### 25. Low-dose rapamycin once a week improved immune response in healthy older adults

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_rapamycin_aging_phase2` |
| **Stage** | Phase 2 |
| **Published** | 2026-05-06 (109d ago) |
| **Strength** | 62% |
...
## Other  ·  4 candidates
### 26. WHO prequalifies first malaria treatment for infants under six months
...
### 27. ACOG releases 2026 maternal immunization schedule, differing from CDC recommendations
...
### 28. FDA approves first oral antibiotic for serious urinary tract infections
...
### 29. FDA approves first generic single-dose flu treatment, increasing affordability
