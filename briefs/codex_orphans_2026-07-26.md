...
**Total candidates:** 18 across 6 categories
...
### 16. Low-dose rapamycin once a week improved immune response in healthy older adults

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_rapamycin_aging_phase2` |
| **Stage** | Phase 2 |
| **Published** | 2026-05-06 (81d ago) |
| **Strength** | 62% |
...
## Other  ·  2 candidates
### 17. WHO prequalifies first malaria treatment for infants under six months
...
### 18. ACOG releases 2026 maternal immunization schedule, differing from CDC recommendations
