...
**Total candidates:** 11 across 6 categories
...
## Neuro & Mental Health  ·  3 candidates
### 7. FDA tightens monitoring for new Alzheimer's drug in people with a high-risk gene

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_lecanemab_apoe4_safety` |
| **Stage** | Approved / Label |
| **Published** | 2026-05-10 (33d ago) |
| **Strength** | 85% |
...
### 8. Virtual neurology visits as effective as in-person for first-time patient evaluations

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_efba2df41cc84c9f` |
| **Stage** | Phase 3 |
| **Published** | 2026-06-02 (10d ago) |
| **Strength** | 85% |
...
### 9. Single psilocybin session helps depression that didn't respond to standard drugs

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_psilocybin_trd_phase3` |
| **Stage** | Phase 3 |
| **Published** | 2026-05-02 (41d ago) |
| **Strength** | 83% |
...
### 10. Low-dose rapamycin once a week improved immune response in healthy older adults

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_rapamycin_aging_phase2` |
| **Stage** | Phase 2 |
| **Published** | 2026-05-06 (37d ago) |
| **Strength** | 62% |
...
## Other  ·  1 candidate
### 11. WHO prequalifies first malaria treatment for infants under six months
