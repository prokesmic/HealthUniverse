...
**Total candidates:** 35 across 5 categories
...
### 1. Removing fallopian tubes during routine surgery may lower ovarian cancer risk

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_62e029ea6fac2440` |
| **Stage** | Guideline |
| **Published** | 2026-07-14 (60d ago) |
| **Strength** | 90% |
...
### 2. FDA approves first new sunscreen ingredient in 30 years

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_0c157ee7cbf678cc` |
| **Stage** | Approved / Label |
| **Published** | 2026-07-21 (53d ago) |
| **Strength** | 90% |
...
### 3. New algorithm safely rules out blood clots in cancer patients, avoiding CT scans

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_39fdd03b34d86bf2` |
| **Stage** | Phase 3 |
| **Published** | 2026-08-25 (18d ago) |
| **Strength** | 80% |
...
### 4. New guideline adds blood test option for colorectal cancer screening

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_e5887844999f1e27` |
| **Stage** | Guideline |
| **Published** | 2026-09-08 (4d ago) |
| **Strength** | 80% |
...
### 7. Pre-op iron reduces blood needs and improves recovery after heart surgery

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_26eed9a442dc0494` |
| **Stage** | Phase 3 |
| **Published** | 2026-08-24 (19d ago) |
| **Strength** | 85% |
...
### 8. IV iron before heart surgery reduces blood transfusions and improves 90-day recovery

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_b07cf4e81bd58d81` |
| **Stage** | Phase 3 |
| **Published** | 2026-08-26 (17d ago) |
| **Strength** | 85% |
...
### 9. IV iron before heart surgery reduces need for blood transfusions by 7%

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_f8bbb8f9c34029d8` |
| **Stage** | Phase 3 |
| **Published** | 2026-08-22 (21d ago) |
| **Strength** | 80% |
...
### 10. FDA approves first oral drug to lower LDL cholesterol
...
### 11. First OTC glucose monitor approved for children with diabetes
...
### 12. AI-Powered Eye Scan Improves Diabetes Vision Screening Accuracy
...
### 13. First Drug Approved to Lower Pancreatitis Risk in Severe High Triglycerides
...
### 14. FDA approves gene therapy for children 2+ with sickle cell disease

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_ab673401325c68f1` |
| **Stage** | Approved / Label |
| **Published** | 2026-08-18 (25d ago) |
| **Strength** | 90% |
...
### 15. New Guidelines Standardize Diagnosis and Treatment for Heart-Kidney-Metabolic Condition
...
### 16. Bone health: 600 METs-min/week of walking/jogging, plus falls risk assessment.

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_7878d119f83dc7e0` |
| **Stage** | Guideline |
| **Published** | 2026-09-10 (2d ago) |
| **Strength** | 80% |
...
### 17. FDA Approves New ADHD Medication
...
### 18. FDA approves new drug for agitation in Alzheimer's dementia patients

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_4f487e92268d5f9a` |
| **Stage** | Approved / Label |
| **Published** | 2026-06-16 (88d ago) |
| **Strength** | 90% |
...
### 19. FDA approves second over-the-counter naloxone nasal spray for opioid overdose

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_47a96cc94db33c7c` |
| **Stage** | Approved / Label |
| **Published** | 2026-07-28 (46d ago) |
| **Strength** | 90% |
...
### 20. Blood thinner more effective than standard drug for migraines linked to heart hole

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_cd80dcb8bd64e525` |
| **Stage** | Phase 3 |
| **Published** | 2026-08-06 (37d ago) |
| **Strength** | 90% |
...
### 21. FDA approves home start for Alzheimer's antibody treatment
...
### 22. Virtual neurology visits as effective as in-person for first-time patient evaluations

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_efba2df41cc84c9f` |
| **Stage** | Phase 3 |
| **Published** | 2026-06-02 (102d ago) |
| **Strength** | 85% |
...
### 23. Post-surgery confusion linked to future memory problems in older adults
...
### 24. Ebola survivors may face long-term neurological issues, study finds
...
### 25. Web tool helps patients stay on antidepressants longer

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_82c82aa9bbec1885` |
| **Stage** | Phase 3 |
| **Published** | 2026-08-04 (39d ago) |
| **Strength** | 80% |
...
### 26. Pregnant women using acetaminophen not linked to autism or ADHD in children
...
### 27. Mechanical clot removal improves recovery for stroke patients with medium or distal artery blockages.

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_6fe724c3027f0767` |
| **Stage** | Phase 3 |
| **Published** | 2026-09-01 (11d ago) |
| **Strength** | 80% |
...
### 28. Endovascular treatment for large stroke improves 1-year recovery compared to standard care.
...
### 29. Thrombectomy for Stroke Clots in Smaller Arteries Improves Outcomes
...
### 30. New noninvasive scan finds clot source in stroke patients, improving treatment decisions
...
## Other  ·  5 candidates
### 31. WHO prequalifies first malaria treatment for infants under six months
...
### 32. ACOG releases 2026 maternal immunization schedule, differing from CDC recommendations
...
### 33. FDA approves first oral antibiotic for serious urinary tract infections
...
### 34. FDA approves first mRNA flu vaccine, offering new protection against influenza
...
### 35. FDA approves first generic single-dose flu treatment, increasing affordability
