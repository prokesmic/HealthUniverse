...
**Total candidates:** 17 across 6 categories
...
### 3. KRAS-G12D inhibitor MRTX1133: 41% ORR in pancreatic ductal adenocarcinoma

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_kras_g12d_phase1` |
| **Stage** | Phase 1 |
| **Published** | 2026-05-05 (81d ago) |
| **Strength** | 71% |
...
### 4. Low-dose colchicine cuts repeat heart attacks by 31% — now in cardiology guidelines

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_colchicine_postmi_acc` |
| **Stage** | Guideline |
| **Published** | 2026-05-08 (78d ago) |
| **Strength** | 88% |
...
### 5. Memory Changes May Predict Heart Events 8 Years Early

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_e6dece34f86e5874` |
| **Stage** | other |
| **Published** | 2026-06-09 (46d ago) |
| **Strength** | 85% |
...
### 6. One injection a year cut bad cholesterol roughly in half — for the whole year

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_pcsk9_silencing_long` |
| **Stage** | Phase 2 |
| **Published** | 2026-05-04 (82d ago) |
| **Strength** | 78% |
...
### 7. Ozempic-class drug improves fatty liver disease in nearly two-thirds of patients

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_semaglutide_mash_phase3` |
| **Stage** | Phase 3 |
| **Published** | 2026-05-12 (74d ago) |
| **Strength** | 90% |
...
### 8. First OTC glucose monitor approved for children with diabetes

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_3a1173badb98dc91` |
| **Stage** | Approved / Label |
| **Published** | 2026-07-21 (4d ago) |
| **Strength** | 90% |
...
### 9. AI-Powered Eye Scan Improves Diabetes Vision Screening Accuracy
...
## Neuro & Mental Health  ·  5 candidates
### 10. FDA approves new drug for agitation in Alzheimer's dementia patients

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_4f487e92268d5f9a` |
| **Stage** | Approved / Label |
| **Published** | 2026-06-16 (39d ago) |
| **Strength** | 90% |
...
### 11. FDA tightens monitoring for new Alzheimer's drug in people with a high-risk gene

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_lecanemab_apoe4_safety` |
| **Stage** | Approved / Label |
| **Published** | 2026-05-10 (76d ago) |
| **Strength** | 85% |
...
### 12. Virtual neurology visits as effective as in-person for first-time patient evaluations

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_efba2df41cc84c9f` |
| **Stage** | Phase 3 |
| **Published** | 2026-06-02 (53d ago) |
| **Strength** | 85% |
...
### 13. Single psilocybin session helps depression that didn't respond to standard drugs

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_psilocybin_trd_phase3` |
| **Stage** | Phase 3 |
| **Published** | 2026-05-02 (84d ago) |
| **Strength** | 83% |
...
### 14. Post-surgery confusion linked to future memory problems in older adults
...
### 15. Low-dose rapamycin once a week improved immune response in healthy older adults

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_rapamycin_aging_phase2` |
| **Stage** | Phase 2 |
| **Published** | 2026-05-06 (80d ago) |
| **Strength** | 62% |
...
## Other  ·  2 candidates
### 16. WHO prequalifies first malaria treatment for infants under six months
...
### 17. ACOG releases 2026 maternal immunization schedule, differing from CDC recommendations
