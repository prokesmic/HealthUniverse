...
**Total candidates:** 33 across 6 categories
...
### 11. One injection a year cut bad cholesterol roughly in half — for the whole year

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_pcsk9_silencing_long` |
| **Stage** | Phase 2 |
| **Published** | 2026-05-04 (114d ago) |
| **Strength** | 78% |
...
## Metabolic  ·  6 candidates
### 12. Ozempic-class drug improves fatty liver disease in nearly two-thirds of patients

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_semaglutide_mash_phase3` |
| **Stage** | Phase 3 |
| **Published** | 2026-05-12 (106d ago) |
| **Strength** | 90% |
...
### 13. First OTC glucose monitor approved for children with diabetes
...
### 14. AI-Powered Eye Scan Improves Diabetes Vision Screening Accuracy
...
### 15. First Drug Approved to Lower Pancreatitis Risk in Severe High Triglycerides
...
### 16. FDA approves gene therapy for children 2+ with sickle cell disease

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_ab673401325c68f1` |
| **Stage** | Approved / Label |
| **Published** | 2026-08-18 (8d ago) |
| **Strength** | 90% |
...
### 17. New Guidelines Standardize Diagnosis and Treatment for Heart-Kidney-Metabolic Condition
...
### 22. FDA tightens monitoring for new Alzheimer's drug in people with a high-risk gene

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_lecanemab_apoe4_safety` |
| **Stage** | Approved / Label |
| **Published** | 2026-05-10 (108d ago) |
| **Strength** | 85% |
...
### 24. Single psilocybin session helps depression that didn't respond to standard drugs

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_psilocybin_trd_phase3` |
| **Stage** | Phase 3 |
| **Published** | 2026-05-02 (116d ago) |
| **Strength** | 83% |
...
### 29. Low-dose rapamycin once a week improved immune response in healthy older adults

| Field | Value |
|---|---|
| **Breakthrough ID** | `br_rapamycin_aging_phase2` |
| **Stage** | Phase 2 |
| **Published** | 2026-05-06 (112d ago) |
| **Strength** | 62% |
...
## Other  ·  4 candidates
### 30. WHO prequalifies first malaria treatment for infants under six months
...
### 31. ACOG releases 2026 maternal immunization schedule, differing from CDC recommendations
...
### 32. FDA approves first oral antibiotic for serious urinary tract infections
...
### 33. FDA approves first generic single-dose flu treatment, increasing affordability
